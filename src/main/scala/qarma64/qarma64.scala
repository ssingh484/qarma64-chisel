...
val io = IO(new Bundle {
    ...
    val used_sbox_inv = RegInit(VecInit(0.U(64.W), 14.U(64.W), 2.U(64.W), 10.U(64.W), 9.U(64.W), 15.U(64.W), 8.U(64.W), 11.U(64.W), 6.U(64.W), 4.U(64.W), 3.U(64.W), 7.U(64.W), 13.U(64.W), 12.U(64.W), 1.U(64.W), 5.U(64.W)))
    ...
    val permuted_state_block_1 = WireInit(VecInit(Seq.fill(16)(0.U(64.W))))
    val permuted_state_block_2 = WireInit(VecInit(Seq.fill(16)(0.U(64.W))))
    val mixcolumns_block_1 = WireInit(VecInit(Seq.fill(16)(0.U(64.W))))
    ...
    val incol_1_0 = WireInit(VecInit(Seq.fill(4)(0.U(64.W))))
    val incol_1_1 = WireInit(VecInit(Seq.fill(4)(0.U(64.W))))
    val incol_1_2 = WireInit(VecInit(Seq.fill(4)(0.U(64.W))))
    val incol_1_3 = WireInit(VecInit(Seq.fill(4)(0.U(64.W))))
    ...
    val outcol_1_0 = WireInit(VecInit(Seq.fill(4)(0.U(64.W))))
    val outcol_1_1 = WireInit(VecInit(Seq.fill(4)(0.U(64.W))))
    val outcol_1_2 = WireInit(VecInit(Seq.fill(4)(0.U(64.W))))
    val outcol_1_3 = WireInit(VecInit(Seq.fill(4)(0.U(64.W))))
    ...
    for (j <- 0 to 15) //hex to block
    {
        ...
        permuted_state_block_1(0) := xor_block_1(state_permutation(0))
        permuted_state_block_1(1) := xor_block_1(state_permutation(1))
        permuted_state_block_1(2) := xor_block_1(state_permutation(2))
        permuted_state_block_1(3) := xor_block_1(state_permutation(3))
        permuted_state_block_1(4) := xor_block_1(state_permutation(4))
        permuted_state_block_1(5) := xor_block_1(state_permutation(5))
        permuted_state_block_1(6) := xor_block_1(state_permutation(6))
        permuted_state_block_1(7) := xor_block_1(state_permutation(7))
        permuted_state_block_1(8) := xor_block_1(state_permutation(8))
        permuted_state_block_1(9) := xor_block_1(state_permutation(9))
        permuted_state_block_1(10) := xor_block_1(state_permutation(10))
        permuted_state_block_1(11) := xor_block_1(state_permutation(11))
        permuted_state_block_1(12) := xor_block_1(state_permutation(12))
        permuted_state_block_1(13) := xor_block_1(state_permutation(13))
        permuted_state_block_1(14) := xor_block_1(state_permutation(14))
        permuted_state_block_1(15) := xor_block_1(state_permutation(15))

        incol_0_0(0) := permuted_state_block_1(0)
        incol_0_0(1) := permuted_state_block_1(4)
        incol_0_0(2) := permuted_state_block_1(8)
        incol_0_0(3) := permuted_state_block_1(12)

        incol_0_1(0) := permuted_state_block_1(0+1)
        incol_0_1(1) := permuted_state_block_1(4+1)
        incol_0_1(2) := permuted_state_block_1(8+1)
        incol_0_1(3) := permuted_state_block_1(12+1)

        incol_0_2(0) := permuted_state_block_1(0+2)
        incol_0_2(1) := permuted_state_block_1(4+2)
        incol_0_2(2) := permuted_state_block_1(8+2)
        incol_0_2(3) := permuted_state_block_1(12+2)

        incol_0_3(0) := permuted_state_block_1(0+3)
        incol_0_3(1) := permuted_state_block_1(4+3)
        incol_0_3(2) := permuted_state_block_1(8+3)
        incol_0_3(3) := permuted_state_block_1(12+3)
        ...
        mixcolumns_block_1(0) := outcol_0_0(0)
        mixcolumns_block_1(1) := outcol_0_1(0)
        mixcolumns_block_1(2) := outcol_0_2(0)
        mixcolumns_block_1(3) := outcol_0_3(0)
        mixcolumns_block_1(4) := outcol_0_0(1)
        mixcolumns_block_1(5) := outcol_0_1(1)
        mixcolumns_block_1(6) := outcol_0_2(1)
        mixcolumns_block_1(7) := outcol_0_3(1)
        mixcolumns_block_1(8) := outcol_0_0(2)
        mixcolumns_block_1(9) := outcol_0_1(2)
        mixcolumns_block_1(10) := outcol_0_2(2)
        mixcolumns_block_1(11) := outcol_0_3(2)
        mixcolumns_block_1(12) := outcol_0_0(3)
        mixcolumns_block_1(13) := outcol_0_1(3)
        mixcolumns_block_1(14) := outcol_0_2(3)
        mixcolumns_block_1(15) := outcol_0_3(3)

        subbytes_block_1(0) := used_sbox(mixcolumns_block_1(0))
        subbytes_block_1(1) := used_sbox(mixcolumns_block_1(1))
        subbytes_block_1(2) := used_sbox(mixcolumns_block_1(2))
        subbytes_block_1(3) := used_sbox(mixcolumns_block_1(3))
        subbytes_block_1(4) := used_sbox(mixcolumns_block_1(4))
        subbytes_block_1(5) := used_sbox(mixcolumns_block_1(5))
        subbytes_block_1(6) := used_sbox(mixcolumns_block_1(6))
        subbytes_block_1(7) := used_sbox(mixcolumns_block_1(7))
        subbytes_block_1(8) := used_sbox(mixcolumns_block_1(8))
        subbytes_block_1(9) := used_sbox(mixcolumns_block_1(9))
        subbytes_block_1(10) := used_sbox(mixcolumns_block_1(10))
        subbytes_block_1(11) := used_sbox(mixcolumns_block_1(11))
        subbytes_block_1(12) := used_sbox(mixcolumns_block_1(12))
        subbytes_block_1(13) := used_sbox(mixcolumns_block_1(13))
        subbytes_block_1(14) := used_sbox(mixcolumns_block_1(14))
        subbytes_block_1(15) := used_sbox(mixcolumns_block_1(15))


        subbytes_block_2(0) := used_sbox_inv(block_state(0))
        subbytes_block_2(1) := used_sbox_inv(block_state(1))
        subbytes_block_2(2) := used_sbox_inv(block_state(2))
        subbytes_block_2(3) := used_sbox_inv(block_state(3))
        subbytes_block_2(4) := used_sbox_inv(block_state(4))
        subbytes_block_2(5) := used_sbox_inv(block_state(5))
        subbytes_block_2(6) := used_sbox_inv(block_state(6))
        subbytes_block_2(7) := used_sbox_inv(block_state(7))
        subbytes_block_2(8) := used_sbox_inv(block_state(8))
        subbytes_block_2(9) := used_sbox_inv(block_state(9))
        subbytes_block_2(10) := used_sbox_inv(block_state(10))
        subbytes_block_2(11) := used_sbox_inv(block_state(11))
        subbytes_block_2(12) := used_sbox_inv(block_state(12))
        subbytes_block_2(13) := used_sbox_inv(block_state(13))
        subbytes_block_2(14) := used_sbox_inv(block_state(14))
        subbytes_block_2(15) := used_sbox_inv(block_state(15))

        //printf(p"subbytes_block : $subbytes_block\n")

        incol_1_0(0) := subbytes_block_2(0)
        incol_1_0(1) := subbytes_block_2(4)
        incol_1_0(2) := subbytes_block_2(8)
        incol_1_0(3) := subbytes_block_2(12)

        incol_1_1(0) := subbytes_block_2(0+1)
        incol_1_1(1) := subbytes_block_2(4+1)
        incol_1_1(2) := subbytes_block_2(8+1)
        incol_1_1(3) := subbytes_block_2(12+1)

        incol_1_2(0) := subbytes_block_2(0+2)
        incol_1_2(1) := subbytes_block_2(4+2)
        incol_1_2(2) := subbytes_block_2(8+2)
        incol_1_2(3) := subbytes_block_2(12+2)

        incol_1_3(0) := subbytes_block_2(0+3)
        incol_1_3(1) := subbytes_block_2(4+3)
        incol_1_3(2) := subbytes_block_2(8+3)
        incol_1_3(3) := subbytes_block_2(12+3)
        ...
        mixcolumns_block_2(0) := outcol_1_0(0)
        mixcolumns_block_2(1) := outcol_1_1(0)
        mixcolumns_block_2(2) := outcol_1_2(0)
        mixcolumns_block_2(3) := outcol_1_3(0)
        mixcolumns_block_2(4) := outcol_1_0(1)
        mixcolumns_block_2(5) := outcol_1_1(1)
        mixcolumns_block_2(6) := outcol_1_2(1)
        mixcolumns_block_2(7) := outcol_1_3(1)
        mixcolumns_block_2(8) := outcol_1_0(2)
        mixcolumns_block_2(9) := outcol_1_1(2)
        mixcolumns_block_2(10) := outcol_1_2(2)
        mixcolumns_block_2(11) := outcol_1_3(2)
        mixcolumns_block_2(12) := outcol_1_0(3)
        mixcolumns_block_2(13) := outcol_1_1(3)
        mixcolumns_block_2(14) := outcol_1_2(3)
        mixcolumns_block_2(15) := outcol_1_3(3)
        //printf(p"mixcolumns_block : $mixcolumns_block\n")

        permuted_state_block_2(0) := mixcolumns_block_2(state_permutation_inv(0))
        permuted_state_block_2(1) := mixcolumns_block_2(state_permutation_inv(1))
        permuted_state_block_2(2) := mixcolumns_block_2(state_permutation_inv(2))
        permuted_state_block_2(3) := mixcolumns_block_2(state_permutation_inv(3))
        permuted_state_block_2(4) := mixcolumns_block_2(state_permutation_inv(4))
        permuted_state_block_2(5) := mixcolumns_block_2(state_permutation_inv(5))
        permuted_state_block_2(6) := mixcolumns_block_2(state_permutation_inv(6))
        permuted_state_block_2(7) := mixcolumns_block_2(state_permutation_inv(7))
        permuted_state_block_2(8) := mixcolumns_block_2(state_permutation_inv(8))
        permuted_state_block_2(9) := mixcolumns_block_2(state_permutation_inv(9))
        permuted_state_block_2(10) := mixcolumns_block_2(state_permutation_inv(10))
        permuted_state_block_2(11) := mixcolumns_block_2(state_permutation_inv(11))
        permuted_state_block_2(12) := mixcolumns_block_2(state_permutation_inv(12))
        permuted_state_block_2(13) := mixcolumns_block_2(state_permutation_inv(13))
        permuted_state_block_2(14) := mixcolumns_block_2(state_permutation_inv(14))
        permuted_state_block_2(15) := mixcolumns_block_2(state_permutation_inv(15))
        //printf(p"permuted_state_block : $permuted_state_block\n")

        xor_block_2(0) := permuted_state_block_2(0) ^ block_tweakey(0)
        xor_block_2(1) := permuted_state_block_2(1) ^ block_tweakey(1)
        xor_block_2(2) := permuted_state_block_2(2) ^ block_tweakey(2)
        xor_block_2(3) := permuted_state_block_2(3) ^ block_tweakey(3)
        xor_block_2(4) := permuted_state_block_2(4) ^ block_tweakey(4)
        xor_block_2(5) := permuted_state_block_2(5) ^ block_tweakey(5)
        xor_block_2(6) := permuted_state_block_2(6) ^ block_tweakey(6)
        xor_block_2(7) := permuted_state_block_2(7) ^ block_tweakey(7)
        xor_block_2(8) := permuted_state_block_2(8) ^ block_tweakey(8)
        xor_block_2(9) := permuted_state_block_2(9) ^ block_tweakey(9)
        xor_block_2(10) := permuted_state_block_2(10) ^ block_tweakey(10)
        xor_block_2(11) := permuted_state_block_2(11) ^ block_tweakey(11)
        xor_block_2(12) := permuted_state_block_2(12) ^ block_tweakey(12)
        xor_block_2(13) := permuted_state_block_2(13) ^ block_tweakey(13)
        xor_block_2(14) := permuted_state_block_2(14) ^ block_tweakey(14)
        xor_block_2(15) := permuted_state_block_2(15) ^ block_tweakey(15)
        //printf(p"xor_block_2 : $xor_block_2\n")

    when(!io.backwards)
    {
      return_block := subbytes_block_1
    }
    .otherwise
    {
...
val io = IO(new Bundle {
    ...
    val plaintext_in = RegInit(0.U(64.W))
    ...
    val stage2_reg = RegInit(0.U(64.W))
    val stage3_reg = RegInit(0.U(64.W))
    ...
    for (j <- 0 to 15) //hex to block
    {
        block_plaintext(15-j) := ((plaintext_in & ("hF".U << j*4)) >> j*4)
        block_tweak(15-j) := ((tweak_in & ("hF".U << j*4)) >> j*4)
        block_w0(15-j) := ((w0_in & ("hF".U << j*4)) >> j*4)
        block_w1(15-j) := ((w1 & ("hF".U << j*4)) >> j*4)
        block_k0(15-j) := ((k0_in & ("hF".U << j*4)) >> j*4)
    }
    ...
    .otherwise
    {
      for (j <- 0 to 15) //hex to block
      {
          ...
          block_w1(15-j) := ((w0_in & ("hF".U << j*4)) >> j*4)
    ...
    // loop iteration 1
    module_CalcRoundTweakey_rounds0_0.io.tweak := tweak_in
    ...
    //loop iteration 2
    module_CalcRoundTweakey_rounds1_0.io.tweak := tweak_in
    ...
    //loop iteration 3
    module_CalcRoundTweakey_rounds2_0.io.tweak := tweak_in
    ...
    //loop iteration 4
    module_CalcRoundTweakey_rounds3_0.io.tweak := tweak_in
    ...
    stage2_reg := module_Round_rounds3_0.io.round_state
    k0_stage2 := (block_k0_1(0) << (15-0)*4) + (block_k0_1(1) << (15-1)*4) + (block_k0_1(2) << (15-2)*4) + (block_k0_1(3) << (15-3)*4) + (block_k0_1(4) << (15-4)*4) + (block_k0_1(5) << (15-5)*4) + (block_k0_1(6) << (15-6)*4) + (block_k0_1(7) << (15-7)*4) + (block_k0_1(8) << (15-8)*4) + (block_k0_1(9) << (15-9)*4) + (block_k0_1(10) << (15-10)*4) + (block_k0_1(11) << (15-11)*4) + (block_k0_1(12) << (15-12)*4) + (block_k0_1(13) << (15-13)*4) + (block_k0_1(14) << (15-14)*4) + (block_k0_1(15) << (15-15)*4)
    k1_stage2 := (block_k1(0) << (15-0)*4) + (block_k1(1) << (15-1)*4) + (block_k1(2) << (15-2)*4) + (block_k1(3) << (15-3)*4) + (block_k1(4) << (15-4)*4) + (block_k1(5) << (15-5)*4) + (block_k1(6) << (15-6)*4) + (block_k1(7) << (15-7)*4) + (block_k1(8) << (15-8)*4) + (block_k1(9) << (15-9)*4) + (block_k1(10) << (15-10)*4) + (block_k1(11) << (15-11)*4) + (block_k1(12) << (15-12)*4) + (block_k1(13) << (15-13)*4) + (block_k1(14) << (15-14)*4) + (block_k1(15) << (15-15)*4)
    w0_stage2 := ((block_w0(0) << (15-0)*4) + (block_w0(1) << (15-1)*4) + (block_w0(2) << (15-2)*4) + (block_w0(3) << (15-3)*4) + (block_w0(4) << (15-4)*4) + (block_w0(5) << (15-5)*4) + (block_w0(6) << (15-6)*4) + (block_w0(7) << (15-7)*4) + (block_w0(8) << (15-8)*4) + (block_w0(9) << (15-9)*4) + (block_w0(10) << (15-10)*4) + (block_w0(11) << (15-11)*4) + (block_w0(12) << (15-12)*4) + (block_w0(13) << (15-13)*4) + (block_w0(14) << (15-14)*4) + (block_w0(15) << (15-15)*4))
    w1_stage2 := ((block_w1(0) << (15-0)*4) + (block_w1(1) << (15-1)*4) + (block_w1(2) << (15-2)*4) + (block_w1(3) << (15-3)*4) + (block_w1(4) << (15-4)*4) + (block_w1(5) << (15-5)*4) + (block_w1(6) << (15-6)*4) + (block_w1(7) << (15-7)*4) + (block_w1(8) << (15-8)*4) + (block_w1(9) << (15-9)*4) + (block_w1(10) << (15-10)*4) + (block_w1(11) << (15-11)*4) + (block_w1(12) << (15-12)*4) + (block_w1(13) << (15-13)*4) + (block_w1(14) << (15-14)*4) + (block_w1(15) << (15-15)*4))
    tweak_in_stage2 := tweak_in

    //loop iteration 5
    module_CalcRoundTweakey_rounds4_0.io.tweak := tweak_in_stage2
    module_CalcRoundTweakey_rounds4_0.io.k0 := k0_stage2
    ...
    module_Round_rounds4_0.io.state := stage2_reg
    ...
    // loop iteration 5
    module_CalcRoundTweakey_rounds4_1.io.tweak := tweak_in_stage2
    module_CalcRoundTweakey_rounds4_1.io.k0 := k0_stage2
    ...
    //loop iteration 4
    module_CalcRoundTweakey_rounds3_1.io.tweak := tweak_in_stage2
    module_CalcRoundTweakey_rounds3_1.io.k0 := k0_stage2
    ...
    //loop iteration 3
    module_CalcRoundTweakey_rounds2_1.io.tweak := tweak_in_stage2
    module_CalcRoundTweakey_rounds2_1.io.k0 := k0_stage2
    ...
    stage3_reg := module_Round_rounds2_1.io.round_state
    k0_stage3 := k0_stage2
    w1_stage3 := w1_stage2
    tweak_in_stage3 := tweak_in_stage2

    //loop iteration 2
    module_CalcRoundTweakey_rounds1_1.io.tweak := tweak_in_stage3
    module_CalcRoundTweakey_rounds1_1.io.k0 := k0_stage3
    ...
    module_Round_rounds1_1.io.state := stage3_reg
    module_Round_rounds1_1.io.tweakey := module_CalcRoundTweakey_rounds1_1.io.output
    module_Round_rounds1_1.io.backwards := true.B

    //loop iteration 1
    module_CalcRoundTweakey_rounds0_1.io.tweak := tweak_in_stage3
    module_CalcRoundTweakey_rounds0_1.io.k0 := k0_stage3
    ...
    output_reg := module_Round_rounds0_1.io.round_state ^ w1_stage3
    io.ciphertext := output_reg
