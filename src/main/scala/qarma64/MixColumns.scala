...
val io = IO(new Bundle {
    ...
    val block_state = WireDefault(Vec(16, 0.U(64.W)))
    val block_mixed_state = WireDefault(Vec(16, 0.U(64.W)))
    ...
    val incol_0 = WireDefault(Vec(4, 0.U(64.W)))
    val incol_1 = WireDefault(Vec(4, 0.U(64.W)))
    val incol_2 = WireDefault(Vec(4, 0.U(64.W)))
    val incol_3 = WireDefault(Vec(4, 0.U(64.W)))

    val outcol_0 = WireDefault(Vec(4, 0.U(64.W)))
    val outcol_1 = WireDefault(Vec(4, 0.U(64.W)))
    val outcol_2 = WireDefault(Vec(4, 0.U(64.W)))
    val outcol_3 = WireDefault(Vec(4, 0.U(64.W)))
